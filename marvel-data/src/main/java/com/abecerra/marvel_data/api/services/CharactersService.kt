...
import com.abecerra.marvel_data.api.utils.ApiParameters.CHARACTER_DETAIL_URL
...
import com.abecerra.marvel_data.api.utils.ApiParameters.PARAM_ID
...
interface CharactersService {
    ...
    fun getCharacterDetailAsync(
        ...
        @Query(PARAM_API_KEY) key: String = API_KEY,
        @Query(PARAM_HASH) hash: String = HASH
    ): Deferred<ResponseDto<List<CharacterDetailDto>>>
